...
#   [ ! -x custom_local/score.sh ] && \
#     echo "$0: Not scoring because custom_local/score.sh does not exist or not executable." && exit 1;
#   custom_local/score.sh --cmd "$cmd" $scoring_opts $data $graphdir $dir ||
